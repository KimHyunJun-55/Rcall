...
@Component
public class StompJwtAuth {

    private final JwtUtil jwtUtil;

    protected void stompFilter(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws IOException {
